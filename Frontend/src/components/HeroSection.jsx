...
export default function HeroSection({ logout }) {
  return (
    <>
      <header className="flex justify-between items-center px-8 py-5 max-w-7xl mx-auto">
        ...
        <button
          onClick={logout}
          className="bg-green-400 px-6 py-2 rounded-full text-white font-semibold shadow-lg ring-2 ring-green-200 hover:bg-green-500 transition"
        >
          Logout &rarr;
        </button>
      </header>
